...
CFrameStorage::CFrameStorage() : _grayOrientation(CardsOrientationUnknown), _yuvOrientation(CardsOrientationUnknown)
{
    int bufferHeightY = 1920;//1280;
    int bytesPerRowY = 1080;//720;
    
    int bufferHeightUV = 960;//640;
    int bytesPerRowUV = 1080;//720;
...
bool CFrameStorage::SetRawFrame(const Mat& rawFrame, const vector<ParametricLine>& edges, CardsOrientation orientation)
{
...
void CFrameStorage::SetRawY(const void* rawY, const void* rawUV, const vector<ParametricLine>& edges, CardsOrientation orientation)
{
...
const CardsOrientation CFrameStorage::GetYUVOrientation()
{
