...
public:
    ...
    virtual bool SetRawFrame(const Mat& rawFrame, const vector<ParametricLine>& edges, CardsOrientation orientation);
    
    virtual bool NormalizeMatrix(const Mat& matrix, const vector<ParametricLine>& edges, Mat& resultMatrix);
    
    virtual void SetRawY(const void* rawY, const void* rawUV, const vector<ParametricLine>& edges, CardsOrientation orientation);
    ...
    virtual const CardsOrientation GetYUVOrientation();
...
private:
    ...
    CardsOrientation _grayOrientation;
    CardsOrientation _yuvOrientation;
};
